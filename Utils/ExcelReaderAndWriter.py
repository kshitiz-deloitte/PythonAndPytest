...
class ExcelHelper:
    ...
    def check_user_password(self, username, password):
        row, col = self.get_row_column()
        flag = False
        for user_detail in self.my_sheet_obj.range('A2:A{}'.format(row)):
            login_user_index = int(user_detail.get_address(0, 0)[1:])
            actual_password = self.my_sheet_obj.range(f"B{login_user_index}").value
...
# RRR	Action	2h 30m	NTR	Raja mouli	4	Tamil	4	8h 0m	0h 30m	0h 45m	8:0-11:0 11:45-14:45 15:30-18:30 19:15-22:15	400
